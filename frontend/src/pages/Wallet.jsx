      ...
      >
        <div className="inline-flex items-center gap-3 mb-4">
          ...
          <div className="relative w-12 h-12">
            ...
            <div className="absolute inset-0 rounded-full border-2 border-dashed border-amber-300/50" />
          </div>
          <h1 className="text-3xl font-bold text-white">Casino Wallet</h1>
        </div>
        <p className="text-gray-400">Manage your casino funds securely</p>
      </motion.div>
      ...
      >
        ...
        <div className="relative p-8 flex items-center gap-6">
          ...
          <div className="relative w-20 h-20 flex-shrink-0">
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-amber-300 to-amber-700 shadow-xl" />
          ...
          <div className="relative p-6">
            ...
            <div className="flex gap-3 mb-6">
              ...
              >
                {activeTab === 'deposit' && (
                  <>
                    <div className="absolute inset-0 bg-gradient-to-br from-green-500 via-emerald-500 to-green-600" />
              ...
              >
                {activeTab === 'withdraw' && (
                  <>
                    <div className="absolute inset-0 bg-gradient-to-br from-purple-500 via-violet-500 to-purple-600" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
                  </>
                )}
                <span className="relative flex items-center justify-center gap-2">
